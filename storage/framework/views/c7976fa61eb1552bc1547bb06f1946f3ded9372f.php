        ...
        series: [
            {
                ...
                radius: '50%',
                data: [
                    { value: <?php echo e($store->total_money, false); ?>, name: '分销总佣金' },
                    { value: <?php echo e($store->settle_money, false); ?>, name: '已结金额' },
                    { value: <?php echo e($store->balance, false); ?>, name: '余额账户' },
                ],
                emphasis: {
                    itemStyle: {
                        shadowBlur: 10,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/wwwroot/xcx.ylhwlkj.com/resources/views/stores/home.blade.php ENDPATH**/ ?>